...
namespace bojan_recipe.Controllers
{
    public class GalleriesController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("GalleryId,GalleryName,GalleryDescription,GalleryImageUrl")] Gallery gallery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GalleryId,GalleryName,GalleryDescription,GalleryImageUrl")] Gallery gallery)
        {
