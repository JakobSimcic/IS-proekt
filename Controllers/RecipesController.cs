...
namespace bojan_recipe.Controllers
{
    public class RecipesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Preparation,Ingredients,ImageUrl,CaloryCount,Type,FoodType,IsAlcoholic")] Recipe recipe)
        {
            if (id != recipe.Id)
            {
                return NotFound();
